...
proxys = [
    ...
    # shopproxy_net
    ['46.8.17.40', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['46.8.222.147', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['188.130.143.253', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['109.248.142.19', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['188.130.128.212', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['46.8.23.141', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['46.8.212.249', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['46.8.155.89', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['188.130.218.105', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['109.248.138.62', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['188.130.184.3', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['109.248.128.241', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['95.182.125.89', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['46.8.56.219', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['5.183.130.144', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['45.11.20.188', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['45.81.136.9', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['45.86.1.172', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['45.87.253.200', '3000', 'rTfECS6e', 'IBXJQeqy'],
    ['45.87.253.238', '3000', 'rTfECS6e', 'IBXJQeqy'],
    # IPv6
